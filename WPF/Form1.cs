...
namespace WPF
{
    public partial class Form1 : Form
    {
        ...
        private double SumModules(double[] array)
        {
            double sum = 0;
        ...
        private void SortArrayMinimum(double[] array)
        {
